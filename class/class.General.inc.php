...
class General
{
	...
	*/
	...
	function pagination( $mPage, $mCantidad, $totalPag ){
	...
	* Traemos total de registros de nuestra tabla
	*/
	function getRowInstancia($tabla, $where = '', $field="", $orden = "", $limiteInferior = -1, $limiteSuperior = -1, $join = ""){
		//DB_DataObject::debugLevel(1);
		$objDBO = DB_DataObject::Factory($tabla);		
		$campos = $objDBO->table();
		//printVar($campos);
	...
	*/
	function getInstancia($tabla, $fieldData="", $unsetField=NULL, $campoWhere, $join=""){
		//DB_DataObject::debugLevel(1);
		//Crea una nueva instancia de $tabla a partir de DataObject
		$objDBO = DB_DataObject::Factory($tabla);		
		$campos = $objDBO->table();
	...
	* @param campo: arreglo con la dupla campo y valor
	*/
	function getInstancia2($tabla,$campos='',$where='',$join='',$order='',$limit=""){
		//DB_DataObject::debugLevel(1);
		//Crea una nueva instancia de $tabla a partir de DataObject
		$objDBO = DB_DataObject::Factory($tabla);
	...
	*/
	...
	function getTotalDatos($table = '',$fields = '',$conditions = '',$orden = '',$limiteInferior = -1,$limiteSuperior = -1,$disctinc=false){
		//DB_DataObject::debugLevel(1);
   ...
   function borrarTabla(){//DB_DataObject::debugLevel(1);
